...
Name:           ros-noetic-rc-genicam-camera
Version:        1.3.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rc_genicam_camera package
...
Requires:       ros-noetic-rc-genicam-api >= 2.0.3
...
BuildRequires:  ros-noetic-rc-genicam-api >= 2.0.3
...
%changelog
* Tue Feb 09 2021 Felix Ruess <felix.ruess@roboception.de> - 1.3.0-1
- Autogenerated by Bloom

* Fri Jan 29 2021 Felix Ruess <felix.ruess@roboception.de> - 1.2.4-1
- Autogenerated by Bloom

* Wed Jan 27 2021 Heiko Hirschmueller <heiko.hirschmueller@roboception.de> - 1.2.3-1
- Autogenerated by Bloom
